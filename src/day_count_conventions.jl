...
"""
function day_count_fraction(start_date, end_date, ::ACT360)
...
"""
function day_count_fraction(start_dates::Vector{T}, end_dates::Vector{T}, ::ACT360) where T
...
"""
function day_count_fraction(start_dates::Vector{T}, end_dates::Vector{T}, ::ACT365) where T
